...
export default function Welcome() {
  return (
    <div className="my-24 flex items-center justify-center space-x-24 text-center max-sm:flex-col max-sm:space-x-0">
      ...
      <div className="text-center">
        <p className="mb-5  w-[700px] text-center  max-lg:w-[500px] max-md:w-[450px] max-sm:w-[340px] max-[320px]:w-[300px]">
        ...
        <Link href={'/accommodations'}>
          <button className="font_inter rounded-xl border-4 border-bgButton  bg-bgButton px-6 py-4 font-bold text-textButton hover:border-solid hover:bg-transparent max-sm:px-3 max-sm:py-2 max-sm:text-sm ">
