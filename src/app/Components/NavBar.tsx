  ...
  return (
    <nav className="w-full shadow-md">
      ...
      md:text-xl"
        ...
        <ul
          className={`absolute top-0 z-50 flex flex-col items-center gap-14 rounded-l-3xl bg-bgNavBar px-20 py-56 shadow-navBarShadow transition-all duration-500 ease-in md:static
